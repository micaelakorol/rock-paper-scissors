...
const Index = ({score,selectIA,user,scoreIA}) => {
 ...
 {/* ----------------- btn seleccionado por maquina---------------------------- */}
  ...
  <div className='section-game'>
    <h2>Player: You</h2>
   <button onClick={() => user(0)} className='btn-1'> <img src={rock} alt="rock" /> </button>
    <button onClick={() => user(1)} className='btn-2'><img src={paper} alt="paper" /></button>
      <button onClick={() => user(2)} className='btn-3'><img src={scissors} alt="scissors" /></button>
        </div>
          </main>
  )
}
